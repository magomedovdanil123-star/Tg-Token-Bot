...
function helpText() {
  return [
    ...
    "",
    "Функции:",
    `«${REFRESH_BUTTON}» — обновить рыночные данные и исследование.`,
    `«${SIGNAL_PICKER_BUTTON}» — выбрать акцию и получить её сигнал.`,
    "«🔥 Лучшие сигналы» — показать лучшие текущие paper-сигналы.",
    `«${ANALOG_BUTTON}» — найти похожие исторические рыночные ситуации.`,
    `«${INTRADAY_BUTTON}» — запустить внутридневной анализ IMOEX.`,
    `«${WAVES_BUTTON}» — показать волновой анализ Эллиотта и Fibonacci.`,
    ...
    `«${WAVE_STATS_BUTTON}» — посмотреть статистику волновых сигналов.`,
    "",
    "Также доступны команды:",
    "/analysis ТИКЕР — Smart Money-анализ компании.",
    ...
    "/waves — волновой анализ Эллиотта и Fibonacci.",
    "/wave_stats — статистика волновых сигналов.",
    "/wave_result ID результат — записать результат волнового сигнала.",
    "/signal ТИКЕР — сигнал по выбранному тикеру.",
    "/analogs — похожие исторические рыночные ситуации.",
    "/top — лучшие текущие сигналы.",
    "/refresh — обновить данные и исследование.",
