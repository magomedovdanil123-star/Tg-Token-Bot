...
The initial Money Test watchlist includes MOEX tickers SMLT (Самолёт), SOFL (Софтлайн), and DELI (Делимобиль). These tickers stay inactive in the production IMOEX universe but receive their own candle refresh and Money Test scan.
